  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute top-1/4 right-1/4 w-80 h-80 bg-lime-500/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/3 left-1/3 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
      </div>
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground mb-2 uppercase tracking-widest">Access Terminal</h1>
            <p className="text-muted-foreground font-mono text-sm">AUTHENTICATE TO CONTINUE</p>
          </div>
          ...
          <div className="tech-panel p-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="password" className="text-muted-foreground uppercase tracking-wider text-xs">Password</Label>
                <div className="relative">
            ...
            <div className="mt-6 text-center">
              <p className="text-muted-foreground font-mono text-sm">
                NEW USER?{" "}
                <Link href="/signup" className="text-primary hover:text-primary/80 font-bold uppercase" data-testid="link-signup">
                  Initialize Account
                </Link>
              </p>
            </div>
